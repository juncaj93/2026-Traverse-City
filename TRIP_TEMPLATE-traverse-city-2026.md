...
|---|---|---|
| The Boathouse (Sat dinner) | ⏳ Waitlisted, first choice | Notify alert set via OpenTable — no table yet, keep checking |
| Artisan — Traverse City (Sat dinner, backup #1) | ✅ Booked | Sat, Sep 5, 6:30 PM · 2 people · Standard, Pergola-Outdoor Dining · via OpenTable · $25/person no-show fee, call ahead if you can't make it |
| PepeNero (Sat dinner, backup #2) | ✅ Booked | Sat, Sep 5, 6:30 PM · 2 guests · Outdoor seating · via Resy · free cancel before Fri Sep 4, 4:30 PM, after that $25+tax/guest |
| Trattoria Stella (Sun dinner) | ✅ Confirmed | Sun, Sep 6, 2026 · 7:15 PM · 2 guests · booked via Resy |

⚠️ **Decide & cancel the extras.** Artisan and PepeNero are both booked for
the same 6:30 PM Sat slot as backups for The Boathouse — once one is
picked (or the Boathouse comes through), cancel the other two so nobody
gets a no-show fee. PepeNero's free-cancel window closes Fri, Sep 4 at
4:30 PM; Artisan has no stated deadline but call ahead regardless.
...
house-smoked ribs, local beer. Casual patio overlooking the water.
...
**Artisan — Traverse City** (backup #1, booked) — New American, Pergola
outdoor dining.
615 E Front St, Traverse City, MI 49686 · (231) 421-2150
Maps: https://www.google.com/maps/search/?api=1&query=615+E+Front+St%2C+Traverse+City%2C+MI+49686

**PepeNero** (backup #2, booked) — Italian/Mediterranean, outdoor seating.
...
- Checkout 11:00 AM
- Depart — 4hr drive (Labor Day traffic)
